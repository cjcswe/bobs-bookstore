...
|--------------|----------------------|---------------------------|
| Bookstore.Web | `/workplace/cjcswe/ATXDeploymentAgent/src/ATXTransformStratusAgent/workspace/bobs-bookstore/app/Bookstore.Web/Bookstore.Web.csproj` | `/workplace/cjcswe/ATXDeploymentAgent/src/ATXTransformStratusAgent/workspace/bobs-bookstore/app/Bookstore.Web/aws-transform-deploy/`
