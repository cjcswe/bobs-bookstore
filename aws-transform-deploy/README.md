...
|--------------|----------------------|---------------------------|
| Bookstore.Web | `/workplace/cjcswe/ATXDeploymentAgent/src/ATXTransformStratusAgent/bobs-bookstore/app/Bookstore.Web/Bookstore.Web.csproj` | `/workplace/cjcswe/ATXDeploymentAgent/src/ATXTransformStratusAgent/bobs-bookstore/app/Bookstore.Web/aws-transform-deploy/`
